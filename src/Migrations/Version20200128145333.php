 ...
 */
final class Version20200128145333 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE enterprise (id INT AUTO_INCREMENT NOT NULL, activity_id INT NOT NULL, name VARCHAR(255) NOT NULL, adress VARCHAR(255) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, workforce INT DEFAULT NULL, INDEX IDX_B1B36A0381C06096 (activity_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE enterprise ADD CONSTRAINT FK_B1B36A0381C06096 FOREIGN KEY (activity_id) REFERENCES activity (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE job_offer DROP FOREIGN KEY FK_288A3A4EA97D1AC3');
        $this->addSql('ALTER TABLE techno_poste DROP FOREIGN KEY FK_5F9D164051F3C1BC');
        $this->addSql('ALTER TABLE enterprise DROP FOREIGN KEY FK_B1B36A0381C06096');
