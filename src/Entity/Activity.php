...
class Activity
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Enterprise", mappedBy="activity")
     */
    private $enterprises;
    ...
    public function removeEnterprise(Enterprise $enterprise): self
    {
        if ($this->enterprises->contains($enterprise)) {
            ...
            if ($enterprise->getActivity() === $this) {
                $enterprise->setActivity(null);
            }
        }
